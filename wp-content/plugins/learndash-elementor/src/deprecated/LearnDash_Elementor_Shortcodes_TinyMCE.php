<?php
/**
 * Deprecated file for the old LearnDash_Elementor_Shortcodes_TinyMCE class.
 *
 * @deprecated 1.0.5
 *
...
if ( ( class_exists( 'LearnDash_Shortcodes_TinyMCE' ) ) && ( ! class_exists( 'LearnDash_Elementor_Shortcodes_TinyMCE' ) ) ) {
	/**
	 * Deprecated LearnDash_Elementor_Shortcodes_TinyMCE class.
	 *
	 * @deprecated 1.0.5
	 */
	class LearnDash_Elementor_Shortcodes_TinyMCE extends LearnDash_Shortcodes_TinyMCE {
		/**
		 * LearnDash_Elementor_Shortcodes_TinyMCE constructor.
		 *
		 * @since 1.0.3
		 *
		 * @return void
		...
		/**
		 * Enqueues Admin styles and scripts for the Elementor TinyMCE editor.
		 *
		 * @since 1.0.3
		 *
		 * @return void
		...
		/**
		 * Outputs the inline editor styles for the Elementor TinyMCE editor.
		 *
		 * @since 1.0.3
		 *
		 * @return void
		...
		public function inline_editor_styles() {
			if ( apply_filters( 'learndash-element-add-inline-editor_styles', true ) ) { // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores -- Deprecated filter.
				ob_start();
				?>
				...
				$ld_elementor_inline_editor_css = apply_filters( 'learndash-element-filter-inline-editor_styles', $ld_elementor_inline_editor_css ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores -- Deprecated Filter.
