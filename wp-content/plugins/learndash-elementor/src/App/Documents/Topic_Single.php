<?php
/**
 * Topic Single LearnDash Elementor documents class file.
 *
...
/**
 * Topic single LearnDash Elementor documents class.
 *
 * @since 1.0.5
 */
class Topic_Single extends Base {
	/**
	 * Class constructor.
	 *
	 * @since 1.0.5
	...
	public function __construct( array $data = array() ) {
		self::$post_type_slug = learndash_get_post_type_slug( LDLMS_Post_Types::TOPIC );
	...
	public static function get_properties() {
		...
		$properties['condition_type'] = learndash_get_post_type_slug( LDLMS_Post_Types::TOPIC );
	...
	public static function get_type() {
		return learndash_get_post_type_slug( LDLMS_Post_Types::TOPIC );
	}
	...
	public static function get_plural_title() {
		return sprintf(
			...
			esc_html_x( 'Single %s', 'placeholder: Topics ', 'learndash-elementor' ),
