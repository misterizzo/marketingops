<?php
/**
 * Base LearnDash Elementor documents class file.
 *
...
/**
 * Base class for LearnDash Elementor documents.
 *
 * @since 1.0.5
 */
class Base extends Single {
	/**
	 ...
	 * @since 1.0.5
	 *
	 * @param bool    $process_template True or False.
	 * @param integer $post_id Post ID being processed by LearnDash.
	 *
	 * @return bool
	 */
	public function learndash_template_preprocess_filter( $process_template, $post_id = 0 ): bool {
		if (
