...
<div class="<?php echo esc_attr( learndash_get_wrapper_class() ); ?>">
<?php
/**
...
if (
	...
	if ( false === strstr( $content, $shown_content_key ) ) {
		...
		if ( ! empty( $shortcode_out ) ) {
			...
			echo wp_kses( $shortcode_out, $allowed_html );
		}
	}
} else {
		...
		learndash_get_template_part(
			...
			array(
				...
				// translators: placeholders: quiz, attempts count.
					esc_html_x( 'You have already taken this %1$s %2$d time(s) and may not take it again.', 'placeholders: quiz, attempts count', 'learndash-elementor' ),
