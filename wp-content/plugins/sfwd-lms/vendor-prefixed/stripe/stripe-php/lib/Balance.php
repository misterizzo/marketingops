 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject[] $connect_reserved Funds held due to negative balances on connected Custom accounts. You can find the connect reserve balance for each currency and payment type in the <code>source_types</code> property.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject[] $instant_available Funds that you can pay out using Instant Payouts.
