 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $currency_conversion Currency conversion details for automatic currency conversion sessions
 * @property \StellarWP\Learndash\Stripe\StripeObject[] $custom_fields Collect additional information from your customer using custom fields. Up to 3 fields are supported.
 * @property \StellarWP\Learndash\Stripe\StripeObject $custom_text
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Customer's address details are not present on Sessions in <code>setup</code> mode.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this Checkout session if using dynamic payment methods.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $phone_number_collection
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $shipping_details Shipping information for this Checkout Session.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $tax_id_collection
