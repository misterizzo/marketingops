 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Application $application ID of the Connect application that created the charge.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $level3
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Account $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://stripe.com/docs/connect/separate-charges-and-transfers">Connect documentation</a> for details.
