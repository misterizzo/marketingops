 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Application $application The ID of the Connect application that created the Payment Link.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $consent_collection When set, provides configuration to gather active consent from customers.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $payment_intent_data Indicates the parameters to be passed to PaymentIntent creation during checkout.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $restrictions Settings that restrict the usage of a payment link.
 ...
 * @property \StellarWP\Learndash\Stripe\StripeObject[] $shipping_options The shipping rate options applied to the session.
