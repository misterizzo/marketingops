 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $options A set of options for the session’s verification checks.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $provided_details Details provided about the user being verified. These details may be shown to the user.
