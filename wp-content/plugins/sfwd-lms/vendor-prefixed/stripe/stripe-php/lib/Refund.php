 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Charge $charge ID of the charge that's refunded.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $destination_details
 * @property null|string|\StellarWP\Learndash\Stripe\BalanceTransaction $failure_balance_transaction After the refund fails, this balance transaction describes the adjustment made on your account balance that reverses the initial balance transaction.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $next_action
 * @property null|string|\StellarWP\Learndash\Stripe\PaymentIntent $payment_intent ID of the PaymentIntent that's refunded.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\TransferReversal $source_transfer_reversal The transfer reversal that's associated with the refund. Only present if the charge came from another Stripe account.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\TransferReversal $transfer_reversal This refers to the transfer reversal object if the accompanying transfer reverses. This is only applicable if the charge was created using the destination parameter.
 */
