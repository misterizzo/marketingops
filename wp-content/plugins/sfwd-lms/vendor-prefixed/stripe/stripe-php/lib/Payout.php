 ...
 * @property null|string|\StellarWP\Learndash\Stripe\BankAccount|\StellarWP\Learndash\Stripe\Card $destination ID of the bank account or card the payout is sent to.
 * @property null|string|\StellarWP\Learndash\Stripe\BalanceTransaction $failure_balance_transaction If the payout fails or cancels, this is the ID of the balance transaction that reverses the initial balance transaction and returns the funds from the failed payout back in your balance.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Payout $reversed_by If the payout reverses, this is the ID of the payout that reverses this payout.
