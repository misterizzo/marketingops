 ...
 * @property \StellarWP\Learndash\Stripe\Collection<\StellarWP\Learndash\Stripe\FinancialConnections\Account> $accounts The accounts that were collected as part of this Session.
 * @property string $client_secret A value that will be passed to the client to launch the authentication flow.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $filters
