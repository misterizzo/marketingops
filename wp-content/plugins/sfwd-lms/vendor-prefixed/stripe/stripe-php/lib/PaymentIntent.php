 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $amount_details
 * @property int $amount_received Amount that this PaymentIntent collects.
 * @property null|string|\StellarWP\Learndash\Stripe\Application $application ID of the Connect application that created the PaymentIntent.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $last_payment_error The payment error encountered in the previous PaymentIntent confirmation. It will be cleared if the PaymentIntent is later updated for any reason.
 * @property null|string|\StellarWP\Learndash\Stripe\Charge $latest_charge The latest charge created by this PaymentIntent.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this PaymentIntent.
 ...
 * @property null|string|\StellarWP\Learndash\Stripe\Account|\StellarWP\Learndash\Stripe\BankAccount|\StellarWP\Learndash\Stripe\Card|\StellarWP\Learndash\Stripe\Source $source This is a legacy field that will be removed in the future. It is the ID of the Source object that is associated with this PaymentIntent, if one was supplied.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $transfer_data The data that automatically creates a Transfer after the payment finalizes. Learn more about the <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a>.
...
class PaymentIntent extends ApiResource
{
     ...
     * @throws \StellarWP\Learndash\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \StellarWP\Learndash\Stripe\SearchResult<\StellarWP\Learndash\Stripe\PaymentIntent> the payment intent search results
     */
