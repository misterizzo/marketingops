 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $end_user_details Details about the end user.
 ...
 * @property null|\StellarWP\Learndash\Stripe\StripeObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
...
class OutboundPayment extends \StellarWP\Learndash\Stripe\ApiResource
{
     ...
     *
     * @return \StellarWP\Learndash\Stripe\Treasury\OutboundPayment the canceled outbound payment
     */
