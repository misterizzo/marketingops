...
class WpProQuiz_Model_Quiz extends WpProQuiz_Model_Model {
	...
	public function getResultText() {
		...
		} elseif ( is_string( $this->_resultText ) ) {
			$this->_resultText = array(
				'prozent' => array( 0 ),
				'activ'   => array( 1 ),
	...
	public function isQuizRunOnceCookie() {
		$run_once_type = $this->getQuizRunOnceType();
		$run_once_type = absint( $run_once_type );
		if ( in_array( $run_once_type, array( 1, 3 ), true ) ) {
			$this->_quizRunOnceCookie = true;
		} else {
