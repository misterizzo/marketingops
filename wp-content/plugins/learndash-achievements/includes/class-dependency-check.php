...
if ( ! class_exists( 'LearnDash_Dependency_Check_LD_Achievements' ) ) {

	/**
	 * Class LearnDash_Dependency_Check_LD_Achievements
	 */
	final class LearnDash_Dependency_Check_LD_Achievements {
		 ...
		 *
		 * @param bool $set_admin_notice A trigger to set the admin notice.
		 */
