...
use SkyVerge\WooCommerce\Memberships\API\Controller\Membership_Plans;
use SkyVerge\WooCommerce\Memberships\API\Controller\User_Memberships;
...
class REST_API extends Framework\REST_API {
	...
	/** @var Membership_Plans[] instances */
	private $membership_plans = [];

	/** @var User_Memberships[] instances */
	 ...
	 * @return null|User_Memberships|Membership_Plans controller instance
	 */
	 ...
	 *
	 * @see System_Status_Report::get_system_status_report_data() for extending the response data
	 *
	 * @since 1.12.0
	 *
