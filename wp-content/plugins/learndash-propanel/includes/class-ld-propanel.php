	...
	public function scripts( $force_load_scripts = false ) {
		if ( LearnDash_Dependency_Check_ProPanel::get_instance()->check_dependency_results() ) {
			...
			if ( true === $force_load_scripts ) {
				...
				$flatpickr_locale['hourAriaLabel']    = esc_html__( 'Hour', 'ld_propanel' );
				$flatpickr_locale['minuteAriaLabel']  = esc_html__( 'Minute', 'ld_propanel' );
				$flatpickr_locale['monthAriaLabel']   = esc_html__( 'Month', 'ld_propanel' );
				$flatpickr_locale['monthAriaLabel']   = esc_html__( 'Month', 'ld_propanel' );
				$flatpickr_locale['rangeSeparator']   = esc_html__( ' to ', 'ld_propanel' );
				$flatpickr_locale['scrollTitle']      = esc_html__( 'Scroll to increment', 'ld_propanel' );
				$flatpickr_locale['toggleTitle']      = esc_html__( 'Click to toggle', 'ld_propanel' );
				$flatpickr_locale['weekAbbreviation'] = esc_html__( 'Wk', 'ld_propanel' );
				$flatpickr_locale['yearAriaLabel']    = esc_html__( 'Year', 'ld_propanel' );
