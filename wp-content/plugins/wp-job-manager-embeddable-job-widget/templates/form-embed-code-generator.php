...
<form class="job-manager-form">
	...
	<fieldset>
		<label for="widget_featured"><?php _e( 'Listed Jobs', 'wp-job-manager-embeddable-job-widget' ); ?></label>
		<div class="field">
			<select name="widget_featured" id="widget_featured">
				<option value="all-jobs"><?php _e( 'All Jobs', 'wp-job-manager-embeddable-job-widget' ); ?></option>
				<option value="true"><?php _e( 'Featured Jobs', 'wp-job-manager-embeddable-job-widget' ); ?></option>
				<option value="false"><?php _e( 'Exclude Featured Jobs', 'wp-job-manager-embeddable-job-widget' ); ?></option>
			</select>
		</div>
	</fieldset>
	<p>
