<div class="popup moc_moops_tv_popup non-active">
	...
	<div class="popup_content iframe_video">
		<div class="popup_close moc_profile_close">
			<svg viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<defs>
					<linearGradient id="paint0_linear_2365_4013" x1="0.469369" y1="0.514539" x2="15.688" y2="15.7331"
		...
		<div class="moc_popup_script popup_form">
			<script charset="utf-8" type="text/javascript" src="//js.hsforms.net/forms/embed/v2.js"></script>
			<script>
			hbspt.forms.create({
			region: "na1",
			portalId: "8316257",
			formId: "1cca2347-cba4-4404-9b08-d8b4bb880383"
			});
			</script>
		</div>
	</div>
