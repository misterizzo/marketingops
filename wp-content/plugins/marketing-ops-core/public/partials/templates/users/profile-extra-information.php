...
if ( is_user_logged_in() ) {
	...
	$moc_community_badges = ! empty( get_user_meta( $current_userid, 'moc_community_badges', true ) ) ? get_user_meta( $current_userid, 'moc_community_badges', true ) : array();
	if ( empty( $moc_community_badges ) || ! in_array( 'Ambassador', $moc_community_badges, true ) ) {
				...
				<div class= "moc_not_changable_container">
					...
					<div class="box_image_title">
						...
						<div class="profile_status">
							<p><?php echo sprintf( __( 'Profile completeness: %1$s %2$s %3$s', 'marketing-ops-core' ), '<span>', '67%', '</span>' ) ?></p>
						</div>
					</div>
				</div>
				...
				<div class="right_side_box_tabbing_content tabbing_content">
					<div class="tabbing_content_container">
						<div class="link_box column_box">
							<a href="<?php echo esc_url( home_url( '/profile/' ) ); ?>"><?php esc_html_e( 'Profile', 'marketing-ops-core' ); ?></a>
						</div>
						<div class="tab_box column_box active_tab">
							<a href="javascript:;" class="tab_link moc_tab_link" data-post = "post" data-tab="tab_1"><?php esc_html_e( 'Articles', 'marketing-ops-core' ); ?></a>
						</div>
						<div class="tab_box column_box">
							<a href="javascript:;" class="tab_link moc_tab_link" data-post = "podcast" data-tab="tab_2"><?php esc_html_e( 'Podcasts', 'marketing-ops-core' ); ?></a>
						</div>
						<!-- <div class="tab_box column_box">
							<a href="javascript:;" class="tab_link moc_tab_link" data-post = "workshop" data-tab="tab_3"><?php esc_html_e( 'Workshops & Webinars', 'marketing-ops-core' ); ?></a>
						</div>
						<div class="tab_box column_box">
							<a href="javascript:;" class="tab_link moc_tab_link" data-post = "sfwd-courses" data-tab="tab_4"><?php esc_html_e( 'Training Courses', 'marketing-ops-core' ); ?></a>
						</div> -->
					</div>
				</div>
								...
								<div class="column_box column_btn">
									<a href="javascript:;" class="moc_write_post elementor-button-link elementor-button elementor-size-lg" role="button">
										<span class="elementor-button-content-wrapper">
											...
											<span class="elementor-button-text"><?php esc_html_e( 'Write new post', 'marketing-ops-core' ); ?></span>
										</span>
									</a>
								</div>
							</div>
