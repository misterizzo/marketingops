			...
			<div class="agencymaintwotable-right">
				<ul>
					...
					<li>
						...
						APAC, EMEA, North America, South America, US
					</li>
					<li>
						<div class="leftwithicon">
						...
						Affiliate Marketing, Influencer Marketing, Performance PR, Outcome-focused Influencer Marketing, Content, Brand Partnerships, B2B, Mobile, Affiliate Search: TM+, Consultancy
					</li>
					<li>
						<div class="leftwithicon">
						...
						Automotive, B2B, Consumer Packaged Goods, DTC, Education, Entertainment, Financial Services, Gaming, Healthcare, Real Estate, Retail, SMB, Subscription, Telecom, Travel, Finance, Tech/Telecom
					</li>
					<li>
						<div class="leftwithicon">
