			...
			<p><?php esc_html_e( 'Complete your profile to enjoy all the platform\'s benefits.', 'marketingops' ); ?></p>
				<ul class="roundprofilelist">
					<li class="<?php echo esc_attr( $avatar_done ); ?>">
						...
						<button class="addprofilebtn" onclick="windows.location.href='https://example.com';"><?php esc_html_e( 'Add', 'marketingops' ); ?></button>
					</li>
					...
					<li class="profiledone">
						...
						<button class="addprofilebtn"><?php esc_html_e( 'Add', 'marketingops' ); ?></button>
					</li>
