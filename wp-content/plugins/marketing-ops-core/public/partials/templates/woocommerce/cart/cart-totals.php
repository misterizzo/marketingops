...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<tr class="cart-subtotal">
			...
			<td data-title="<?php esc_attr_e( 'Cart Subtotal', 'woocommerce' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) :
			...
			<tr class="cart-discount nirabme coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
				...
				<td data-title="<?php echo esc_attr( $coupon_title ); ?>"><?php wc_cart_totals_coupon_html( $coupon ); ?></td>
			</tr>
		<?php endforeach; ?>
