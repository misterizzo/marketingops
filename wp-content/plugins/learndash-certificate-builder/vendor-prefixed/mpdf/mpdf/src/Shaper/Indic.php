...
namespace LearnDash\Certificate_Builder\Mpdf\Shaper;
...
class Indic
{
	...
	public static function insert_dotted_circles(&$info, $dottedcircle)
	{
		...
		if (isset($info[$idx])) {
			throw new \LearnDash\Certificate_Builder\Mpdf\MpdfException('Unexpected error occurred in Indic processing');
		}
