...
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Filter\FilterException;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\PdfParser;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\PdfParserException;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\StreamReader;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfArray;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfBoolean;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfDictionary;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfHexString;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfIndirectObject;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfIndirectObjectReference;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfName;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfNull;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfNumeric;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfStream;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfString;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfToken;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfType;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfParser\Type\PdfTypeException;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfReader\DataStructure\Rectangle;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfReader\PageBoundaries;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfReader\PdfReader;
use LearnDash\Certificate_Builder\setasign\Fpdi\PdfReader\PdfReaderException;
