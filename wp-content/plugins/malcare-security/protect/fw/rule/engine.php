...
if (!class_exists('MCProtectFWRuleEngine_V568')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V568 {
	use MCProtectFWRuleStringFunc_V568;
	use MCProtectFWRuleArrayFunc_V568;
	use MCProtectFWRuleMiscFunc_V568;
	use MCProtectFWRuleRequestFunc_V568;
	use MCProtectFWRuleWPFunc_V568;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V568::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V568 $e) {
			$this->error = $e;
		}
	}
