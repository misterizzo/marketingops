...
if (!class_exists('MCProtectFWRuleEngine_V556')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V556 {
	use MCProtectFWRuleStringFunc_V556;
	use MCProtectFWRuleArrayFunc_V556;
	use MCProtectFWRuleMiscFunc_V556;
	use MCProtectFWRuleRequestFunc_V556;
	use MCProtectFWRuleWPFunc_V556;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V556::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V556 $e) {
			$this->error = $e;
		}
	}
