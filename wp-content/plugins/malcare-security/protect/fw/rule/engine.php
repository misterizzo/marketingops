...
if (!class_exists('MCProtectFWRuleEngine_V573')) :
require_once dirname( __FILE__ ) . '/functions.php';

class MCProtectFWRuleEngine_V573 {
	use MCProtectFWRuleStringFunc_V573;
	use MCProtectFWRuleArrayFunc_V573;
	use MCProtectFWRuleMiscFunc_V573;
	use MCProtectFWRuleRequestFunc_V573;
	use MCProtectFWRuleWPFunc_V573;
	...
	const CONST_NAME_PREFIX = 'MCProtectFWRule_V573::';
	...
	public function evaluate($rule) {
		...
		} catch (MCProtectRuleError_V573 $e) {
			$this->error = $e;
		}
	}
