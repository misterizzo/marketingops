...
class Pinnacle extends AbstractTheme
{
    ...
    {
        $settings[] = [
            'id'       => 'pinnacle_password_reset_headline',
            'type'     => 'text',
        ...
        $settings[] = [
            'id'       => 'pinnacle_password_reset_login_link_label',
            'type'     => 'text',
    ...
    public function default_metabox_settings()
    {
        ...
        $data['pinnacle_password_reset_headline']         = esc_html__('Forgot Password?', 'profilepress-pro');
        $data['pinnacle_password_reset_login_link_label'] = esc_html__('Back to Login', 'profilepress-pro');
        $data['submit_button_text']                       = esc_html__('Get New Password', 'profilepress-pro');
    ...
    public function form_structure()
    {
        ...
        $headline         = $this->get_meta('pinnacle_password_reset_headline');
        $login_link_label = $this->get_meta('pinnacle_password_reset_login_link_label');
...
<hr/>
	<div class="pp_pinnacle loginContent" style="background:#f0f0f0;">
		<div style="float:left;">
			<a class="pp_pinnacle" href="[link-login raw]">$login_link_label</a>
		</div>
