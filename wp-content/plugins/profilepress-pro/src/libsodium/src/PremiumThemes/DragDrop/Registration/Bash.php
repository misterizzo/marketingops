...
class Bash extends AbstractTheme
{
    ...
    public function default_fields_settings()
    {
        ...
        $defaults['reg-username']['placeholder'] = '';
        $defaults['reg-username']['label']       = esc_html__('Username', 'profilepress-pro');

        $defaults['reg-email']['placeholder'] = '';
        $defaults['reg-email']['label']       = esc_html__('Email', 'profilepress-pro');

        $defaults['reg-password']['placeholder'] = '';
        $defaults['reg-password']['label']       = esc_html__('Password', 'profilepress-pro');

        $defaults['reg-first-name']['placeholder'] = '';
        $defaults['reg-first-name']['label']       = esc_html__('First Name', 'profilepress-pro');

        $defaults['reg-last-name']['placeholder'] = '';
        $defaults['reg-last-name']['label']       = esc_html__('Last Name', 'profilepress-pro');
    ...
    public function appearance_settings($settings)
    {
        ...
        $settings[] = [
            'id'       => 'bash_registration_login_link_label',
            'type'     => 'text',
        ...
        if ($this->is_show_social_login()) {
            ...
            $settings[] = [
                'id'       => 'bash_registration_social_buttons',
                'type'     => 'select2',
                'options'  => [
    ...
    public function social_login_buttons()
    {
        ...
        $active_social_logins = $this->get_meta('bash_registration_social_buttons');
    ...
    public function default_metabox_settings()
    {
        ...
        $data['bash_registration_headline']         = esc_html__('Create an Account', 'profilepress-pro');
        $data['bash_registration_login_link_label'] = esc_html__('Have an account?', 'profilepress-pro');
        $data['bash_registration_social_buttons']   = ['facebook', 'twitter', 'google'];
    ...
    public function form_structure()
    {
        ...
        $headline         = $this->get_meta('bash_registration_headline');
        $login_link_label = $this->get_meta('bash_registration_login_link_label');
...
[pp-form-wrapper class="bash"]
    ...
    <div style="margin-top: 20px;">
        $button
        <a class="bash-existing" href="[link-login raw]">$login_link_label</a>
    </div>
[/pp-form-wrapper]
HTML;
