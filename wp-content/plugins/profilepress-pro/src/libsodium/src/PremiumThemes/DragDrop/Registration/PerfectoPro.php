...
class PerfectoPro extends AbstractTheme
{
    ...
    {
        $settings[] = [
            'id'       => 'perfectopro_registration_headline',
            'type'     => 'text',
        ...
        if ($this->is_show_social_login()) {
            ...
            $settings[] = [
                'id'       => 'perfectopro_registration_social_buttons',
                'type'     => 'select2',
    ...
    public function color_settings($settings)
    {
        $settings2 = [
            [
                'id'    => 'perfectopro_registration_bg_color',
                'type'  => 'color',
                'label' => esc_html__('Background', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectopro_registration_border',
                'type'  => 'color',
                'label' => esc_html__('Form Border', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectopro_registration_text_color',
                'type'  => 'color',
                'label' => esc_html__('Text', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectopro_registration_placeholder_color',
                'type'  => 'color',
                'label' => esc_html__('Field Placeholder', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectopro_registration_button_bg_color',
                'type'  => 'color',
                'label' => esc_html__('Button Background', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectopro_registration_button_text_color',
                'type'  => 'color',
    ...
    public function social_login_buttons()
    {
        ...
        $active_social_logins = $this->get_meta('perfectopro_registration_social_buttons');
    ...
    public function default_metabox_settings()
    {
        ...
        $data['perfectopro_registration_headline']          = esc_html__('Create an Account', 'profilepress-pro');
        $data['perfectopro_registration_bg_color']          = '#f0f0f0';
        $data['perfectopro_registration_border']            = '#f0f0f0';
        $data['perfectopro_registration_text_color']        = '#555555';
        $data['perfectopro_registration_placeholder_color'] = '#555555';
        $data['perfectopro_registration_button_bg_color']   = '#196cd8';
        $data['perfectopro_registration_button_text_color'] = '#ffffff';
        $data['perfectopro_registration_social_buttons']    = ['facebook', 'twitter', 'google', 'linkedin'];
    ...
    public function form_structure()
    {
        ...
        $headline = $this->get_meta('perfectopro_registration_headline');
...
HTML;
    ...
    public function form_css()
    {
        ...
        $bg_color          = $this->get_meta('perfectopro_registration_bg_color');
        $border_color      = $this->get_meta('perfectopro_registration_border');
        $text_color        = $this->get_meta('perfectopro_registration_text_color');
        $placeholder_color = $this->get_meta('perfectopro_registration_placeholder_color');
        $button_bg_color   = $this->get_meta('perfectopro_registration_button_bg_color');
        $button_text_color = $this->get_meta('perfectopro_registration_button_text_color');
...
div#pp-$form_type-$form_id.perfecto .pp-form-field-wrap select.pp-form-field {
...
div#pp-$form_type-$form_id.perfecto .pp-form-field-wrap .pp-form-label {
    font-size: 14px;
    line-height: 20px;
    letter-spacing: .2px;
}

div#pp-$form_type-$form_id.perfecto .pp-form-field-wrap input.pp-form-field[type="file"] {
    color: #A9A9A9;
    line-height: 18px;
}
