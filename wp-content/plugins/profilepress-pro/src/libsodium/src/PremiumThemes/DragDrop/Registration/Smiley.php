...
class Smiley extends AbstractTheme
{
    ...
    {
        $settings[] = [
            'id'       => 'smiley_registration_header_image',
            'type'     => 'upload',
        ...
        $settings[] = [
            'id'       => 'smiley_registration_headline',
            'type'     => 'text',
        ...
        $settings[] = [
            'id'       => 'smiley_registration_login_label',
            'type'     => 'text',
    ...
    public function default_metabox_settings()
    {
        ...
        $data['smiley_registration_headline']     = esc_html__('Register', 'profilepress-pro');
        $data['smiley_registration_login_label']  = esc_html__('Already Registered?', 'profilepress-pro');
        $data['smiley_registration_header_image'] = $this->asset_image_url . "/smiley/avatar.gif";
    ...
    public function form_structure()
    {
        ...
        $headline         = $this->get_meta('smiley_registration_headline');
        $login_link_label = $this->get_meta('smiley_registration_login_label');
        $header_image     = $this->get_meta('smiley_registration_header_image');
...
div#pp-$form_type-$form_id .smiley1 .roundtop {
  border-top-left-radius:4px;
  border-top-right-radius:4px;
}
...
div#pp-$form_type-$form_id.smiley1 .pp-gender, 
...
div#pp-$form_type-$form_id.smiley1 input[type=text]:focus, div#pp-$form_type-$form_id.smiley1 input[type=password]:focus {
	outline: 0;
}
...
div#pp-$form_type-$form_id.smiley1 .ppsocialmedia .ppsochead {
	font-weight: 500;
	font-size: 16px;
}
...
div#pp-$form_type-$form_id.smiley1 label {
  color: #fff;
}

div#pp-$form_type-$form_id.smiley1 .pp-gender:focus, div#pp-$form_type-$form_id.smiley1 select:focus {
	outline: none;
}
