...
class Perfecto extends AbstractTheme
{
    ...
    {
        $settings[] = [
            'id'       => 'perfectolite_password_reset_headline',
            'type'     => 'text',
    ...
    public function color_settings($settings)
    {
        $settings2 = [
            [
                'id'    => 'perfectolite_password_reset_bg_color',
                'type'  => 'color',
                'label' => esc_html__('Background', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectolite_password_reset_border',
                'type'  => 'color',
                'label' => esc_html__('Form Border', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectolite_password_reset_text_color',
                'type'  => 'color',
                'label' => esc_html__('Text', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectolite_password_reset_placeholder_color',
                'type'  => 'color',
                'label' => esc_html__('Field Placeholder', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectolite_password_reset_button_bg_color',
                'type'  => 'color',
                'label' => esc_html__('Button Background', 'profilepress-pro')
            ],
            [
                'id'    => 'perfectolite_password_reset_button_text_color',
                'type'  => 'color',
    ...
    public function default_metabox_settings()
    {
        ...
        $data['perfectolite_password_reset_headline']          = esc_html__('Reset Your Password', 'profilepress-pro');
        $data['perfectolite_password_reset_bg_color']          = '#ffffff';
        $data['perfectolite_password_reset_border']            = '#f0f0f0';
        $data['perfectolite_password_reset_text_color']        = '#555555';
        $data['perfectolite_password_reset_placeholder_color'] = '#555555';
        $data['perfectolite_password_reset_button_bg_color']   = '#196cd8';
        $data['perfectolite_password_reset_button_text_color'] = '#ffffff';
    ...
    public function form_structure()
    {
        ...
        $headline     = $this->get_meta('perfectolite_password_reset_headline');
...
HTML;
    ...
    public function form_css()
    {
        ...
        $bg_color          = $this->get_meta('perfectolite_password_reset_bg_color');
        $border_color      = $this->get_meta('perfectolite_password_reset_border');
        $text_color        = $this->get_meta('perfectolite_password_reset_text_color');
        $placeholder_color = $this->get_meta('perfectolite_password_reset_placeholder_color');
        $button_bg_color   = $this->get_meta('perfectolite_password_reset_button_bg_color');
        $button_text_color = $this->get_meta('perfectolite_password_reset_button_text_color');
