...
class Pinnacle extends AbstractTheme
{
    ...
    {
        $settings[] = [
            'id'       => 'pinnacle_registration_headline',
            'type'     => 'text',
        ...
        if ($this->is_show_social_login()) {
            ...
            $settings[] = [
                'id'       => 'pinnacle_registration_social_buttons',
                'type'     => 'select2',
        ...
        $settings[] = [
            'id'       => 'pinnacle_registration_login_text',
            'type'     => 'text',
        ...
        $settings[] = [
            'id'       => 'pinnacle_registration_login_link_label',
            'type'     => 'text',
    ...
    public function social_login_buttons()
    {
        ...
        $active_social_logins = $this->get_meta('pinnacle_registration_social_buttons');
    ...
    public function default_metabox_settings()
    {
        ...
        $data['pinnacle_registration_headline']         = esc_html__('Create an Account', 'profilepress-pro');
        $data['pinnacle_registration_login_text']       = esc_html__('Have an account?', 'profilepress-pro');
        $data['pinnacle_registration_login_link_label'] = esc_html__('Log In', 'profilepress-pro');
        $data['pinnacle_registration_social_buttons']   = ['facebook', 'twitter', 'google', 'linkedin'];
    ...
    public function form_structure()
    {
        ...
        $headline            = $this->get_meta('pinnacle_registration_headline');
        $login_link_label    = $this->get_meta('pinnacle_registration_login_link_label');
        $login_text          = $this->get_meta('pinnacle_registration_login_text');
...
<div class="pp_pinnacle loginContent" style="background:#f0f0f0;">
    <div style="float:left;">$login_text<br/> <a class="pp_pinnacle" href="[link-login raw]">$login_link_label</a></div>
    <div style="float:right;">$registration_button</div>
</div>
[/pp-form-wrapper]
HTML;
...
div#pp-$form_type-$form_id.pp_pinnacle .pp_pinnacle.loginInputField:focus {
