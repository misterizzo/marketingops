...
class Pinnacle implements PasswordResetThemeInterface
{
...
<div class="pp_pinnacle loginContainer">
	<div class="pp_pinnacle loginContent">
		[user-login class="pp_pinnacle loginInputField" placeholder="Username or Email Address"]
	</div>
	<hr/>
	<div class="pp_pinnacle loginContent" style="background:#f0f0f0;">
		<div style="float:left;">
			<a class="pp_pinnacle" href="[link-login raw]">Back to Login</a>
		</div>
		<div style="float:right;">
			[reset-submit class="pp_pinnacle loginInputSubmit" value="Get New Password"]
		</div>
	</div>
</div>
CODE;
    ...
    {
        return '<div class="pinnacle-success">Check your email for further instruction.</div>';
    }
