...
class Parallel implements LoginThemeInterface
{
...
<div class="pp-parallel-container">
	<div class="pp-parallel">
		[login-username class="pp-parallel-input" placeholder="Username"]
		[login-password class="pp-parallel-input" placeholder="Password"]
		[login-submit class="pp-parallel-submit" value="Log In"]
