...
class Pinnacle implements RegistrationThemeInterface
{
...
<div class="pp_pinnacle loginContainer">
	<div class="pp_pinnacle loginContent">
		<div class="pp_pinnacle loginTitle">Sign Up</div>
		<br/>
	...
	<hr/>
	<div class="pp_pinnacle loginContent">
		[reg-username class="pp_pinnacle loginInputField" title="Username" placeholder="Username"]
		[reg-email class="pp_pinnacle loginInputField" title="Email Address" placeholder="Email Address"]
		[reg-password class="pp_pinnacle loginInputField" title="Password" placeholder="Password"]
		[reg-first-name class="pp_pinnacle loginInputField" title="First Name" placeholder="First Name"]
		[reg-last-name class="pp_pinnacle loginInputField" title="Last Name" placeholder="Last Name"]
	</div>
	<hr/>
	<div class="pp_pinnacle loginContent" style="background:#f0f0f0;">
		<div style="float:left;">
		Have an account?<br/> <a class="pp_pinnacle" href="[link-login raw]">Log In</a>
		</div>
		<div style="float:right;">
			[reg-submit class="pp_pinnacle loginInputSubmit" value="Register"]
		</div>
	</div>
</div>
CODE;
    ...
    {
        return '<div class="pinnacle-success">Registration Successful.</div>';
    }
