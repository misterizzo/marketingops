...
class Parallel implements RegistrationThemeInterface
{
...
<div class="pp-parallel-container">
	<div class="pp-parallel">
		[reg-username class="pp-parallel-input" placeholder="Username"]
		[reg-email class="pp-parallel-input" placeholder="Email address"]
		[reg-password class="pp-parallel-input" placeholder="Password"]
		[reg-submit class="pp-parallel-submit" value="Sign Up"]
...
CODE;
    ...
    {
        return '<div class="pp-parallelSuccess">Registration Successful</div>';
    }
