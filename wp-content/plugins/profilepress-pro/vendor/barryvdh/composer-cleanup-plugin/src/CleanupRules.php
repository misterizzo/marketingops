...
class CleanupRules
{
    public static function getRules()
    {
        ...
        $tests = '.travis.yml .php_cs gulpfile.js package.json styleci.yml puli.json .scrutinizer.yml phpunit.xml* phpcs.php phpunit.php test tests Tests travis patchwork.json config.codekit3';
        ...
        return array(
            ...
            'fusewp/core' => array($docs, $tests),
            'fusewp/libsodium' => array($docs, $tests),
            'feedbackwp/libsodium' => array($docs, $tests),
