...
class FuseWP
{
    ...
    public function __construct()
    {
        ...
        if (wp_doing_ajax()) {
            add_action('wp_ajax_ppress_fusewp_page_check_plugin_status', array($this, 'ajax_check_plugin_status'));
        }
    ...
    public function ppress_install_plugin()
    {
        ...
        set_current_screen('ppress_page_ppress-fusewp');

        // Prepare variables.
        $url = esc_url_raw(
            add_query_arg(
                ['page' => 'ppress-settings'],
                admin_url('admin.php')
            )
        );
    ...
    public function register_settings_page()
    {
        $newIndicator = sprintf(
            '<span class="ppress-menu-new-indicator">&nbsp;%s</span>',
    ...
    {
        wp_enqueue_script(
            'ppress-admin-page-fusewp',
            PPRESS_ASSETS_URL . "/js/admin/fusewp.js",
            array('jquery'),
        ...
        \wp_localize_script('ppress-admin-page-fusewp', 'ppress_installer_globals', [
    ...
    public function output()
    {
        ...
        <style>
            ...
            #ppress-admin-fusewp .notice,
            #ppress-admin-fusewp .error {
                display: none
            }

            #ppress-admin-fusewp *, #ppress-admin-fusewp *::before, #ppress-admin-fusewp *::after {
                -webkit-box-sizing: border-box;
                -moz-box-sizing: border-box;
                box-sizing: border-box;
            }

            #ppress-admin-fusewp section {
                margin: 50px 0;
                text-align: left;
                clear: both;
            }

            #ppress-admin-fusewp section.screenshot {
                text-align: center;
            }

            #ppress-admin-fusewp .top {
                text-align: center;
            }

            #ppress-admin-fusewp .top img {
                margin-bottom: 38px;
                width: 480px;
                height: auto;
            }

            #ppress-admin-fusewp .top h1 {
                font-size: 26px;
                font-weight: 600;
                margin-bottom: 0;
                padding: 0;
            ...
            #ppress-admin-fusewp .top p {
                font-size: 17px;
                color: #777777;
                margin-top: .5em;
            }

            #ppress-admin-fusewp p {
                font-size: 15px;
            }

            #ppress-admin-fusewp .cont {
            ...
            #ppress-admin-fusewp .screenshot > * {
                vertical-align: middle;
            }

            #ppress-admin-fusewp .screenshot .cont img {
                max-width: 100%;
                display: block;
            }

            #ppress-admin-fusewp .screenshot ul {
                display: inline-block;
                margin: 0 0 0 30px;
            ...
            #ppress-admin-fusewp .screenshot li {
                margin: 16px 0;
                padding: 0 0 0 24px;
                font-size: 15px;
                color: #777777;
            ...
            #ppress-admin-fusewp .step .loader {
                margin-top: -54px;
                transition: all .3s;
                opacity: 1;
            }

            #ppress-admin-fusewp .step .hidden {
                opacity: 0;
                transition: all .3s;
            }

            #ppress-admin-fusewp .step div {
                display: inline-block;
            ...
            #ppress-admin-fusewp .step p {
                font-size: 16px;
                color: #777777;
            }


            #ppress-admin-fusewp .step .button {
                font-weight: 500;
                box-shadow: none;
                padding: 12px;
                min-width: 200px;
            ...
            #ppress-admin-fusewp .grey {
                opacity: 0.5;
            }
        </style>
        <?php
        echo '<div id="ppress-admin-fusewp" class="wrap ppress-admin-wrap ppress-admin-plugin-landing">';
    ...
    protected function output_section_heading()
    {
        ...
        printf(
            ...
            esc_url(PPRESS_ASSETS_URL . '/images/profilepressXfusewp.png'),
            esc_attr__('ProfilePress ♥ FuseWP', 'wp-user-avatar'),
    ...
    protected function output_section_screenshot()
    {
        printf(
            ...
            PPRESS_ASSETS_URL . '/images/fusewp-user-sync-edit-screen.png',
