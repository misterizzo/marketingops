<?php
/**
 * Deprecated LearnDash Dependency Check class file.
 *
 * @deprecated 1.6.3
 *
 * @since 1.0.0
...
if ( ! class_exists( 'LearnDash_Dependency_Check_LD_Notifications' ) ) {
	/**
	 * Deprecated class.
	 *
	 * @deprecated 1.6.3 Use LearnDash\Notifications\Utilities\Dependency_Checker instead.
	 *
	 * @since 1.0.0
	 */
	final class LearnDash_Dependency_Check_LD_Notifications {
		/**
		...
		/**
		 * The array of plugin) to check Should be key => label pair. The label can be anything to display
		 *
