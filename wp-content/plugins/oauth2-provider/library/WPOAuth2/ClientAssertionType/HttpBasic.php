...
class HttpBasic implements ClientAssertionTypeInterface {
	 ...
	 *                                                                   // whether to look for credentials in the
	 *                                                                   POST body in addition to the Authorize HTTP
	 *                                                                   Header 'allow_public_clients'  => true
	 *                                                                   // if true, "public clients" (clients without
	 *                                                                   a secret) may be authenticated ); </code>
	 */
