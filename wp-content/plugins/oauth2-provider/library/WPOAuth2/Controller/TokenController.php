...
*/
		...
		/**
		 * wp_oauth_server_user_check action for role checking and other checks before an access token is returned
		 */
		do_action( 'wp_oauth_server_user_check', $clientId, $grantType->getUserId() );
