...
<nav class="job-manager-pagination">
	<ul>
		<?php if ( $current_page && $current_page > 1 ) : ?>
			<li class="moc_prev_page_li"><a href="#" data-page="<?php echo esc_attr( $current_page - 1 ); ?>">&larr;</a></li>
		<?php endif; ?>
		...
		<?php if ( $current_page && $current_page < $max_num_pages ) : ?>
			<li class="moc_next_page_li"><a href="#" data-page="<?php echo esc_attr( $current_page + 1 ); ?>">&rarr;</a></li>
		<?php endif; ?>
	</ul>
</nav>
